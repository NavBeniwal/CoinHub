...
public class BuyLimitTradingPage {
    WebDriver driver;
    BasePage basePage;
    ...
    public BuyLimitTradingPage(WebDriver driver){
        this.driver=driver;
    ...
    public boolean validateBeforeAndAfterPlaceBuyLimitOrderBalanceOfUSDT(ExtentTest test) throws IOException, InterruptedException {
        boolean isTrue = false;
    ...
    public boolean validateBeforeAndAfterPlaceBuyLimitOrderBalanceOfCurrency(ExtentTest test) throws IOException, InterruptedException {
        boolean isTrue = false;
    ...
    public boolean validateBeforeAndAfterCancelBuyLimitOrderBalanceOfUSDT(ExtentTest test) throws IOException, InterruptedException {
        boolean isTrue = false;
    ...
    public boolean validateBeforeAndAfterCancelBuyLimitOrderBalanceOfCurrency(ExtentTest test) throws IOException, InterruptedException {
        boolean isTrue = false;

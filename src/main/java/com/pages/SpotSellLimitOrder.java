...
public class SpotSellLimitOrder {
    ...
    private By availableBalanceOfCurrency= By.xpath("(//h4)[13]");
    private By availableBalanceOfUSDT= By.xpath("(//h4)[15]");
    ...
    private By placeSellOrderButton= By.xpath("(//span[text()=' PLACE BUY ORDER'])[2]");
    ...
    public boolean validateSellLimitOrderCreatedSuccessfully(String createOrder,ExtentTest test) throws IOException, InterruptedException {
        ...
        String beforePlaceSellLimitOrderTotalAvailableBalanceOfUSDT = basePage.doGetElementText(availableBalanceOfUSDT);
        ...
        String beforePlaceSellLimitOrderTotalAvailableBalanceOfCurrency = basePage.doGetElementText(availableBalanceOfCurrency);
        ...
        String getCurrencyAmt = basePage.getAttribute((WebElement) limitEnterAmountTextField);
    ...
    public boolean validateAfterPlaceSellLimitOrderBalanceOfCurrency(ExtentTest test) throws IOException, InterruptedException {
        ...
        String amountOfCurrency=basePage.doGetElementText(amount);
    ...
    public boolean validateAfterCancelLimitOrderStatusShouldBeCancelledOnTradeHistoryPage(ExtentTest test) throws IOException, InterruptedException {
        ...
        if(tradeHistoryPageStatus.equals(limitCancelOrderStatus)){
            isTrue=true;
            test.log(LogStatus.FAIL,test.addScreenCapture(BasePage.getScreenCapture(driver)),"Verified cancelled order is showing on trade history page.");
        }else {
            isTrue=false;
            test.log(LogStatus.PASS,test.addScreenCapture(BasePage.getScreenCapture(driver)),"Verified cancelled order isn't showing on trade history page.");
        }

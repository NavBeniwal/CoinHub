...
public class BuyLimitTradingPageValidation {
    WebDriver driver;
    BasePage basePage;

    public BuyLimitTradingPageValidation(WebDriver driver) {
        this.driver = driver;
    ...
    public boolean validatePriceIsRequiredValidationMessage(String priceRequired, ExtentTest test) throws IOException, InterruptedException {
        ...
        test.log(LogStatus.INFO, test.addScreenCapture(BasePage.getScreenCapture(driver)), "Verified remove the value from the buy BNB limit price text field.");
    ...
    public boolean validateOrderNotAsPerTradingRulesWithLowPriceValidationMessage(String orderNotAsPerTradingRules, ExtentTest test) throws IOException {
        ...
        test.log(LogStatus.INFO, test.addScreenCapture(BasePage.getScreenCapture(driver)), "Verified enter the value in the buy BNB limit price text field.");
    ...
    public boolean validateInsufficientBalanceValidationMessage(String insufficientBalance, ExtentTest test) throws IOException {
        ...
        //Enter the value in the sell limit price text field
        basePage.waitForElementToBeVisible(limitPriceTextField);
        basePage.enterText(limitPriceTextField, buyPrice);
        test.log(LogStatus.INFO, test.addScreenCapture(BasePage.getScreenCapture(driver)), "Verified enter the value in the sell BNB limit price text field.");
    ...
    public boolean validateTotalAmountMustBeAboveValidationMessage(String totalAmountMustBeAbove, ExtentTest test) throws IOException {
        ...
        //Remove the value from the buy limit total text field
        basePage.click(limitTotalTextField);
        basePage.clearValue(limitTotalTextField);
        test.log(LogStatus.INFO, test.addScreenCapture(BasePage.getScreenCapture(driver)), "Verified remove the value from the buy BNB limit total text field.");

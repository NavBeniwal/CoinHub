...
public class SpotBuyLimitOrder {
    ...
    private By availableBalanceOfUSDT= By.xpath("(//h4)[12]");
    private By limitBtn= By.xpath("//div[text()='LIMIT']");
    private By amount= By.xpath("//td[@class='ant-table-cell']/span");
    private By remainingAmount= By.xpath("//div[@class='flexCenter']/p");
    private By filledAmount= By.xpath("(//div[@class='flexCenter'])[3]");
    private By currencyPrice= By.xpath("(//td[@class='ant-table-cell']/div)[2]");
    private By orderType= By.xpath("//p[text()='Limit']");
    private By limitPriceTextField= By.xpath("//input[@placeholder='Enter Price']");
    private By limitTotalTextField= By.xpath("(//input[@placeholder='Total'])[2]");
    private By limitEnterAmountTextField= By.xpath("(//input[@placeholder='Enter Amount'])[2]");
    ...
    private By clickOnCancelBtn= By.xpath("(//div[text()='Cancel'])[1]");
    private By orderCancelledSuccessfullyPopUpMsg= By.xpath("//span[text()='Order cancelled successfully']");
    private By totalAmount= By.xpath("(//td[@class='ant-table-cell']/p)[24]");
    private By openOrders= By.xpath("//p[text()='Open Orders']");
    ...
    public boolean validateBuyLimitOrderCreatedSuccessfully(String createOrder,ExtentTest test) throws IOException, InterruptedException {
        ...
        String beforePlaceBuyLimitOrderTotalAvailableBalanceOfUSDT = basePage.doGetElementText(availableBalanceOfUSDT);
        ...
        String beforePlaceBuyLimitOrderTotalAvailableBalanceOfCurrency = basePage.doGetElementText(availableBalanceOfCurrency);
...
//        test.log(LogStatus.INFO, test.addScreenCapture(BasePage.getScreenCapture(driver)), "Verified clicked on the limit button.");
        ...
        basePage.waitForElementToBeVisible(limitPriceTextField);
        String limitPriceTextFieldValue=basePage.getAttribute((WebElement) limitPriceTextField);
        double limitPriceFieldValue=Double.parseDouble(limitPriceTextFieldValue.replace(",",""));
        System.out.println("Value is: "+limitPriceTextFieldValue);
        ...
        basePage.enterText(limitTotalTextField, "1");
        basePage.doClearValue(limitPriceTextField);
        ...
        //Total amount
        basePage.waitForElementToBeVisible(limitTotalTextField);
        String USDTAmount = basePage.getAttribute((WebElement) limitTotalTextField);
        ...
        String getCurrencyAmount = basePage.getAttribute((WebElement) limitEnterAmountTextField);
    ...
    public boolean validateAfterPlaceBuyLimitOrderBalanceOfUSDT(ExtentTest test) throws IOException, InterruptedException {
        ...
        String afterPlaceLimitOrderAvailableBalanceOfUSDTIs= basePage.doGetElementText(availableBalanceOfUSDT);
    ...
    public boolean validateAfterPlaceBuyLimitOrderBalanceOfCurrency(ExtentTest test) throws IOException, InterruptedException {
        ...
        String afterPlaceLimitOrderAvailableBalanceOfCurrencyIs= basePage.doGetElementText(availableBalanceOfCurrency);
    ...
    public boolean validateEnterAmountAndOpenOrderAmountValueShouldBeEqual(ExtentTest test) throws IOException {
        ...
        //Convert string values to double
        String amountVal=basePage.doGetElementText(amount);
    ...
    public boolean validateFilledAmountValue(ExtentTest test) throws IOException {
        ...
        //Convert string values to double
        String filledAmt=basePage.doGetElementText(filledAmount);
    ...
    public boolean validateEnterCurrencyPriceAndOpenOrdersPriceShouldBeEqual(ExtentTest test) throws IOException {
        ...
        //Split the value
        String priceValue=basePage.doGetElementText(currencyPrice);
    ...
    public boolean validateOrderTypeShouldBeLimit(ExtentTest test) throws IOException {
        ...
        //Get the value
        String limitOrderTypeIs=basePage.doGetElementText(orderType);
    ...
    public boolean validateAfterPlacedLimitOrderStatusShouldBeNewOnAllOrdersPage(ExtentTest test) throws IOException, InterruptedException {
        ...
        String allOrdersPageStatus=basePage.doGetElementText(status);
    ...
    public boolean validateCancelBuyLimitOrderMessage(String cancelOrder,ExtentTest test) throws IOException, InterruptedException {
        ...
        String orderCancel=basePage.doGetElementText(orderCancelledSuccessfullyPopUpMsg);
    ...
    public boolean validateAfterCancelLimitOrderStatusShouldBeCancelledOnTradeHistoryPage(ExtentTest test) throws IOException, InterruptedException {
        ...
        String limitCancelOrderStatus=PropertyReaderOptimized.getKeyValue("limitCancelOrderStatus");
        test.log(LogStatus.INFO,test.addScreenCapture(BasePage.getScreenCapture(driver)),"After cancelled limit order on trade history page status should not be: "+limitCancelOrderStatus);
        ...
        if(tradeHistoryPageStatus.equals(limitCancelOrderStatus)){
            isTrue=true;
            test.log(LogStatus.FAIL,test.addScreenCapture(BasePage.getScreenCapture(driver)),"Cancelled order is showing on trade history page.");
        }else {
            isTrue=false;
            test.log(LogStatus.PASS,test.addScreenCapture(BasePage.getScreenCapture(driver)),"Cancelled order isn't showing on trade history page.");
        }

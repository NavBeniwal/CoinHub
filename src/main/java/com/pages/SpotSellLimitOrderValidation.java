...
public class SpotSellLimitOrderValidation {
    ...
    private By priceIsRequiredValidationMsg= By.xpath("//span[text()='Price is required']");
    ...
    private By totalAmountMustBeAboveValidationMsg= By.xpath("totalAmountMustBeAboveValidationMsg");
    private By orderNotAsPerTradingRulesErrorMsg= By.xpath("//span[text()='Order not as per trading rules.']");
    private By priceShouldBeLessOrEqualToValidationMsg= By.xpath("(//span[@class='errorCls'])[3]");
    ...
    public boolean validatePriceIsRequiredValidationMessage(String priceRequired, ExtentTest test) throws IOException, InterruptedException {
        ...
        String priceIsRequired = basePage.doGetElementText(priceIsRequiredValidationMsg);
    ...
    public boolean validateOrderNotAsPerTradingRulesWithHighPriceValidationMessage(String orderNotAsPerTradingRules, ExtentTest test) throws IOException {
        ...
        String orderNotAsPerTradingRulesValidation = basePage.doGetElementText(orderNotAsPerTradingRulesErrorMsg);
    ...
    public boolean validatePriceShouldBeLessThanOrEqualToValidationMessage(String priceShouldBeLessOrEqualTo, ExtentTest test) throws IOException {
        ...
        String priceShouldBeLessThanOrEqualTo = basePage.doGetElementText(priceShouldBeLessOrEqualToValidationMsg);

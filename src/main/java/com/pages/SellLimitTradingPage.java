...
public class SellLimitTradingPage {
    WebDriver driver;
    BasePage basePage;
    ...
    public SellLimitTradingPage(WebDriver driver){
        this.driver=driver;
    ...
    public boolean validateBeforeAndAfterPlaceSellLimitOrderBalanceOfUSDT(ExtentTest test) throws IOException, InterruptedException {
        boolean isTrue = false;
    ...
    public boolean validateBeforeAndAfterPlaceSellLimitOrderBalanceOfCurrency(ExtentTest test) throws IOException, InterruptedException {
        boolean isTrue = false;
    ...
    public boolean validateBeforeAndAfterCancelSellLimitOrderBalanceOfUSDT(ExtentTest test) throws IOException, InterruptedException {
        boolean isTrue = false;
    ...
    public boolean validateBeforeAndAfterCancelSellLimitOrderBalanceOfCurrency(ExtentTest test) throws IOException, InterruptedException {
        boolean isTrue = false;
        ...
        test.log(LogStatus.INFO,test.addScreenCapture(BasePage.getScreenCapture(driver)),"After cancel sell limit order available balance of currency is:  "+afterPlaceSellLimitOrderBalanceOfCurrency);

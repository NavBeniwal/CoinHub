...
//    }
//    public void waitForElementToBeInvisible(WebElement wb) {
//        WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(120));
...
//    }
    ...
    public void doSendKeys(WebElement wb, String value) {
        wb.sendKeys(value);
    }
...
//    }
    ...
    public void doClearValue(By locator) {
        Actions action = new Actions(driver);
        for (int i = 0; i < 10; i++) {
            action.sendKeys(Keys.BACK_SPACE).build().perform();
        }
    ...
    public void search(String searchKey, By searchLocator, String suggName, By suggestions)
        ...
        doSendKeys((WebElement) searchLocator, searchKey);
        Thread.sleep(3000);
    ...
    public void clickWithWait(By tradeBtn) {
        getElement(locator).click();
    }
}
